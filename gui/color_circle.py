from PyQt5.QtCore import QPointF, Qt, QLineF, QRect, pyqtSignal
from PyQt5.QtGui import QPainter, QConicalGradient, QColor, QResizeEvent, QPaintEvent, QMouseEvent, QRadialGradient
